        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    LastTemporaryPassword = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    PasswordChangedByReader = table.Column<bool>(type: "bit", nullable: false),
                    LastPasswordChangeOn = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NewsUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SearchKeywords = table.Column<string>(type: "nvarchar(1200)", maxLength: 1200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PasswordResetRequests_Readers_ReaderId",
                        column: x => x.ReaderId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReaderFavoriteBooks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReaderFavoriteBooks_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ReaderFavoriteBooks_Readers_ReaderId",
                        column: x => x.ReaderId,
                        principalTable: "Readers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Reminder7DaysSent = table.Column<bool>(type: "bit", nullable: false),
                    Reminder3DaysSent = table.Column<bool>(type: "bit", nullable: false),
                    Reminder1DaySent = table.Column<bool>(type: "bit", nullable: false),
                    LastOverdueReminderSentOn = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReaderNotifications", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReaderNotifications_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ReaderNotifications_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ReaderNotifications_Loans_LoanId",
                        column: x => x.LoanId,
                        principalTable: "Loans",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ReaderNotifications_Readers_ReaderId",
                        column: x => x.ReaderId,
                        principalTable: "Readers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "ReaderFavoriteBooks",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_ReaderFavoriteBooks_ReaderId_BookId",
                table: "ReaderFavoriteBooks",
                columns: new[] { "ReaderId", "BookId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ReaderNotifications_BookId",
                table: "ReaderNotifications",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_ReaderNotifications_CategoryId",
                table: "ReaderNotifications",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_ReaderNotifications_LoanId",
                table: "ReaderNotifications",
                column: "LoanId");

            migrationBuilder.CreateIndex(
                name: "IX_ReaderNotifications_ReaderId",
                table: "ReaderNotifications",
                column: "ReaderId");
